...
public:
	...
	Property()                                 : type(PT_EMPTY), parent(-1), count(0),   name(nullptr), val(nullptr), idx(-1){}
	Property(CSTR n, I32 *v, U32 cnt = 1)      : type(PT_I32),   parent(-1), count(cnt), name(n), val(v), idx(-1) {}
	Property(CSTR n, F32 *v, U32 cnt = 1)      : type(PT_F32),   parent(-1), count(cnt), name(n), val(v), idx(-1) {}
	Property(CSTR n, CSTR *v)                  : type(PT_CSTR),  parent(-1), count(1),   name(n), val(v), idx(-1) {}
	Property(CSTR n)                           : type(PT_EMPTY), parent(-1), count(0),   name(n), val(nullptr), idx(-1) {}
