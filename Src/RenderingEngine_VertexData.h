...
public:
	...
	basic_array<U16> u16_indicesData;
	basic_array<U32> u32_indicesData;
	basic_array<F32> f32_weights;
	basic_array<U16> u16_boneIDs;
//	std::vector<U8> u8_boneIDs;

	VertexDescription(U32 *pIndices, U32 numTriangles, U32 numVertices, F32 *pVertices, F32 *pTexCoords, F32 *pNormals, F32 *pTangents, F32 *pBitangents, F32 *pColors)
	{
		...
		if (uint16IsFine)
		{
			u16_indicesData.resize(m_numIndices);
		...
		{
			u32_indicesData.resize(m_numIndices);
